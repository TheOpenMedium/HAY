 ...
 */
class Version20180129213120 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE comment ADD id_status_id INT NOT NULL, ADD id_user_id INT NOT NULL, DROP id_user, DROP id_status');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE comment ADD id_user INT NOT NULL, ADD id_status INT NOT NULL, DROP id_status_id, DROP id_user_id');
