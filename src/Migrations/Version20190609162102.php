 ...
 */
final class Version20190609162102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE laws (id INT AUTO_INCREMENT NOT NULL, user_id VARCHAR(100) NOT NULL, date DATETIME NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_B0D3F907A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, reporter_id VARCHAR(100) NOT NULL, reported_user_id VARCHAR(100) NOT NULL, reported_post_id VARCHAR(10) DEFAULT NULL, reported_comment_id VARCHAR(10) DEFAULT NULL, date DATETIME NOT NULL, law VARCHAR(255) NOT NULL, reporter_msg LONGTEXT DEFAULT NULL, emergency_level INT NOT NULL, validated TINYINT(1) DEFAULT NULL, punishment VARCHAR(255) DEFAULT NULL, punishment_expiration_date DATETIME DEFAULT NULL, moderator_msg LONGTEXT DEFAULT NULL, needhelp TINYINT(1) DEFAULT NULL, date_limit_contest DATETIME DEFAULT NULL, contested TINYINT(1) DEFAULT NULL, contest_result TINYINT(1) DEFAULT NULL, INDEX IDX_C42F7784E1CFE6F5 (reporter_id), INDEX IDX_C42F7784E7566E (reported_user_id), INDEX IDX_C42F7784EC0086D7 (reported_post_id), INDEX IDX_C42F77849368B60F (reported_comment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE report_user (report_id INT NOT NULL, user_id VARCHAR(100) NOT NULL, INDEX IDX_FEBF3BB24BD2A4C0 (report_id), INDEX IDX_FEBF3BB2A76ED395 (user_id), PRIMARY KEY(report_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE survey (id VARCHAR(10) NOT NULL, user_id VARCHAR(100) NOT NULL, law_id INT DEFAULT NULL, report_id INT DEFAULT NULL, date DATETIME NOT NULL, question VARCHAR(255) NOT NULL, answers LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', color LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', expiration_date DATE DEFAULT NULL, role VARCHAR(255) NOT NULL, INDEX IDX_AD5F9BFCA76ED395 (user_id), UNIQUE INDEX UNIQ_AD5F9BFC54EB478 (law_id), UNIQUE INDEX UNIQ_AD5F9BFC4BD2A4C0 (report_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE survey_post (survey_id VARCHAR(10) NOT NULL, post_id VARCHAR(10) NOT NULL, INDEX IDX_9C636C46B3FE509D (survey_id), INDEX IDX_9C636C464B89032C (post_id), PRIMARY KEY(survey_id, post_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE survey_comment (survey_id VARCHAR(10) NOT NULL, comment_id VARCHAR(10) NOT NULL, INDEX IDX_D05871D7B3FE509D (survey_id), INDEX IDX_D05871D7F8697D13 (comment_id), PRIMARY KEY(survey_id, comment_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id VARCHAR(10) NOT NULL, user_id VARCHAR(100) NOT NULL, post_id VARCHAR(10) NOT NULL, comment LONGTEXT NOT NULL, date_send DATETIME NOT NULL, INDEX IDX_9474526CA76ED395 (user_id), INDEX IDX_9474526C4B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE post (id VARCHAR(10) NOT NULL, user_id VARCHAR(100) NOT NULL, content LONGTEXT NOT NULL, date_post DATETIME NOT NULL, color VARCHAR(3) NOT NULL, size VARCHAR(2) NOT NULL, font VARCHAR(2) NOT NULL, INDEX IDX_5A8A6C8DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE notification (id VARCHAR(10) NOT NULL, user_id VARCHAR(100) NOT NULL, type INT NOT NULL, content LONGTEXT NOT NULL, date_send DATETIME NOT NULL, url VARCHAR(255) DEFAULT NULL, url_id INT DEFAULT NULL, INDEX IDX_BF5476CAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE friend_request (id INT AUTO_INCREMENT NOT NULL, from_user_id VARCHAR(100) NOT NULL, to_user_id VARCHAR(100) NOT NULL, INDEX IDX_F284D942130303A (from_user_id), INDEX IDX_F284D9429F6EE60 (to_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id VARCHAR(100) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, username VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, date_sign DATETIME NOT NULL, mail_conf TINYINT(1) NOT NULL, url VARCHAR(2000) NOT NULL, alt VARCHAR(255) DEFAULT NULL, settings JSON DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_user (user_source VARCHAR(100) NOT NULL, user_target VARCHAR(100) NOT NULL, INDEX IDX_F7129A803AD8644E (user_source), INDEX IDX_F7129A80233D34C1 (user_target), PRIMARY KEY(user_source, user_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
